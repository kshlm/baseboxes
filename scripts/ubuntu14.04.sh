...
case "$PACKER_BUILDER_TYPE" in
		...
		apt-get --purge -y autoremove binutils cpp cpp-4.8 gcc kpartx libcloog-isl4 libgmp10 libisl10 libmpc3 libmpfr4 make
	...
	virtualbox-iso)
		...
		# Remove development tools.
		apt-get --purge -y autoremove binutils cpp cpp-4.8 libcloog-isl4 libgmp10 libisl10 libmpc3 libmpfr4 make gcc
